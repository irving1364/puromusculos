...
const categoria = ({ productos, categorias, categoriaMadre, agregarCarrito }) => {
    ...
    return (
        <>
            <Wrapper>
                <SEO pageTitle={categoriaMadre} />
                <Header />
                <main id="main-content">
                    <Breadcrumb
                        pageTitle={categoriaMadre}
...
export const getServerSideProps = async (context) => {
    ...
    const data = await fetch("https://fadimet.com.pa/alberto/index.php/wp-json/wc/v3/products/categories?search=" + context.query.categoria + "", requestOptions);
    const result = await data.json();
    console.log(result);



    const catParent = await fetch("https://fadimet.com.pa/alberto/index.php/wp-json/wc/v3/products?per_page=99&category=" + result[0].id + "", requestOptions);
    ...
    return {
        props: {
            productos: resultCat,
            categorias: null,
            categoriaMadre: context.query.categoria,
